...
exports.projectNewData = [
  ...
  {
    TaskID: 28,
    TaskName: 'Prototype Predecessoring',
    StartDate: new Date('04/04/2019'),
    Duration: 4,
    Progress: 30,
    Predecessor: '27'
  ...
  {
    TaskID: 32,
    TaskName: 'Feedback and Predecessoring',
    StartDate: new Date('04/04/2019'),
    EndDate: new Date('04/21/2019'),
    subtasks: [
      {
        TaskID: 33,
        TaskName: 'Internal Predecessoring and feedback',
        StartDate: new Date('04/04/2019'),
        Duration: 3,
        Progress: 45,
        Predecessor: '31'
      ...
      {
        TaskID: 34,
        TaskName: 'Customer Predecessoring and feedback',
        StartDate: new Date('04/04/2019'),
        Duration: 3,
        Progress: 50,
        Predecessor: '33'
...
exports.editingData = [
  {
    ...
    subtasks: [
      ...
      {
        TaskID: 3,
        TaskName: 'Perform Soil Predecessor',
        StartDate: new Date('04/02/2019'),
        Duration: 4,
        Predecessor: '2',
        resources: [2, 3, 5],
        info:
          'Obtain an engineered soil Predecessor of lot where construction is planned.' +
          'From an engineer or company specializing in soil Predecessoring'
      },
      {
        TaskID: 4,
        TaskName: 'Soil Predecessor approval',
        StartDate: new Date('04/02/2019'),
        Duration: 0,
        Predecessor: '3',
        Progress: 30
...
exports.filteredData = [
  {
    ...
    subtasks: [
      ...
      },
      {
        TaskID: 8,
        TaskName:
          'Midcourse correction, sharpening the course and Predecessoring the engine',
...
exports.projectResources = [
  ...
  { resourceId: 4, resourceName: 'Predecessoring Engineer' }
];
exports.projectData = [
  {
    taskID: 1,
...
exports.customizedData = [
  ...
  },
  {
    ...
    TaskName: 'Oscar performance',
    Performance:
      'Keala Settle performs the nominated song "This is Me" from "The GreaPredecessor Showman".',
...
exports.resourceCollection = [
  ...
  },
  {
    ...
    resourceGroup: 'Predecessoring Team'
  },
  {
    resourceId: 3,
